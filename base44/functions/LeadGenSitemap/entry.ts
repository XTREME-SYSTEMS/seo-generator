// Generates XML sitemap for leadgennearyou.com programmatic city pages
// Public endpoint — no auth needed (Google fetches this)
// Usage: /functions/LeadGenSitemap?host=leadgennearyou.com
...
export default async function(req) {
  try {
    ...
    const host = url.searchParams.get("host") || "leadgennearyou.com";
