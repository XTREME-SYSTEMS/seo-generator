...
export default function Ecosystem() {
  ...
  const [scopes, setScopes] = useState(['read', 'fix', 'sync']);
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        <Panel title="API Endpoints" subtitle="POST to /functions/EcosystemApi">
          <div className="space-y-2">
            {ENDPOINTS.map((e) => (
              <div key={e.action} className="rounded-md border border-border p-3">
                <div className="flex items-center gap-2">
                  ...
                  <StatusPill tone="idle">{e.scope}</StatusPill>
                </div>
